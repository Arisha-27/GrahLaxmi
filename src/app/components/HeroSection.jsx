...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between px-8 sm:px-24 py-12 sm:py-20 relative overflow-hidden bg-[#FFF5F5]">
      {/* Left Section */}
      <div className="max-w-2xl text-center sm:text-left sm:ml-20 flex flex-col justify-center sm:-mt-32">
        <h1 className="text-[52px] sm:text-[72px] font-bold text-[#a61965] leading-tight mb-3">
          Empowering <br /> Women to <br /> Grow Wealth
        ...
        <button
          ...
          className="bg-[#d9534f] text-white font-bold px-[32px] py-[16px] text-[20px] rounded hover:bg-[#c7433f] hover:scale-105 hover:shadow-lg transition-all duration-300 ease-in-out self-center sm:self-start"
        >
          Get Started
        </button>
      </div>
